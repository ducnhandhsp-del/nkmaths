...
export const colors = {
  primary:   { 50:'#eef2ff',100:'#e0e7ff',200:'#c7d2fe',400:'#818cf8',500:'#4f46e5',600:'#4338ca',700:'#3730a3', grad:'linear-gradient(135deg,#4f46e5,#3730a3)' },
  secondary: { 50:'#f5f3ff',400:'#a78bfa',500:'#8b5cf6',600:'#7c3aed', grad:'linear-gradient(135deg,#8b5cf6,#7c3aed)' },
  success:   { 50:'#dcfce7',200:'#a7f3d0',500:'#10b981',600:'#065f46', grad:'linear-gradient(135deg,#10b981,#065f46)' },
  warning:   { 50:'#fef3c7',200:'#fde68a',500:'#f59e0b',600:'#78350f', grad:'linear-gradient(135deg,#f59e0b,#78350f)' },
  danger:    { 50:'#fee2e2',200:'#fecaca',500:'#ef4444',600:'#7f1d1d', grad:'linear-gradient(135deg,#ef4444,#7f1d1d)' },
  ...
  neutral:   { 0:'#ffffff',50:'#f8fafc',100:'#f1f3fb',200:'#e8eaf3',300:'#d8ddea',400:'#9ca3af',500:'#6b7280',600:'#475569',700:'#334155',800:'#1e293b',900:'#1a1d2e' },
...
export const typography = {
  ...
  letterSpacing: { tight:'0',normal:'0',wide:'0.04em',wider:'0.08em',widest:'0.12em' },
} as const;

export const spacing = { 1:4,2:8,3:12,4:16,5:20,6:24,7:28,8:32,10:40,12:48,16:64 } as const;
export const radius  = { sm:8,md:12,lg:16,xl:20,'2xl':22,full:9999 } as const;
export const shadows = {
  xs:'0 1px 3px rgba(15,23,42,0.06)', sm:'0 2px 12px rgba(79,70,229,0.09)',
  md:'0 4px 18px rgba(15,23,42,0.10)', lg:'0 8px 28px rgba(79,70,229,0.18)', xl:'0 18px 48px rgba(15,23,42,0.24)',
  primary:'0 8px 24px rgba(79,70,229,0.30)', success:'0 8px 24px rgba(16,185,129,0.26)',
  warning:'0 8px 24px rgba(245,158,11,0.26)', danger:'0 8px 24px rgba(239,68,68,0.24)',
} as const;
